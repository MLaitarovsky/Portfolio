...
export default function Footer() {
  return (
    <footer style={{ borderTop: '1px solid var(--border)' }}>
      <div style={{ maxWidth: '1120px', margin: '0 auto', padding: '56px 24px 32px' }}>
        ...
        >
          ...
          <div style={{ maxWidth: '240px' }}>
            ...
            <p style={{ color: 'var(--text-dim)', fontSize: '14px', lineHeight: 1.65 }}>
              Full-stack engineer & Olympic athlete building production-grade software.
            </p>
          </div>
        ...
        >
          <span style={{ fontSize: '13px', color: 'var(--text-dim)' }}>
            &copy; 2026 Michael Laitarovsky
          </span>
          <span style={{ fontSize: '13px', color: 'var(--text-dim)' }}>Built with discipline</span>
        </div>
